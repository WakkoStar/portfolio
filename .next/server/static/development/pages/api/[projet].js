...
/* harmony default export */ __webpack_exports__["default"] = (({
  ...
  const filtered = _data__WEBPACK_IMPORTED_MODULE_0__["projects"].filter(p => p.link === projet); // User with id exists

  if (filtered.length > 0) {
    res.status(200).json(filtered[0]);
  } else {
    res.status(404).json({
      message: `Project with link: ${projet} not found.`
    });
  }
});
...
/***/ 7:
/*!*************************************!*\
  !*** multi ./pages/api/[projet].js ***!
  \*************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Documents\GitHub\portfolio\pages\api\[projet].js */"./pages/api/[projet].js");
